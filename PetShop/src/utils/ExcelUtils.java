...
public class ExcelUtils {
	...
	public static boolean setWorkSheetByString(String nameSheet) {
		try {
	...
	public static double getNumDataAt(int row, int column) {
		try {
			XSSFRow r = sheet.getRow(row);
			XSSFCell celija = r.getCell(column);
			double br = celija.getNumericCellValue();
	...
	public static boolean setCellAt(int row, int column, String data) {
		try {
			XSSFRow r = sheet.getRow(row);
